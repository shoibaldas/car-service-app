            ...
            <div className="hero-content flex-col gap-24 lg:flex-row">
                <div className='w-2/5'>
                    <div className="text-center lg:text-left">
                        <img className='w-full md:w-4/5' src={img} alt="" />
                    </div>
                </div>
                <div className='md:w-3/5 md:mt-0 -mt-20'>
                    ...
                    <div className="card flex-shrink-0 max-w-md md:max-w-lg shadow-2xl bg-base-200">
                        <form onSubmit={handleSignUp} className="card-body">
                            ...
                            <div className="form-control mt-4">
                                <button type="submit" className="bg-orange-600 text-gray-50 hover:bg-orange-700 py-2 rounded-md">Sign in</button>
                            </div>
                            <div>
                                <h5 className='label-text-alt'>Already have an account?<Link to='/login' className='text-orange-600 link link-hover font-semibold hover:text-orange-700'> Sign in</Link></h5>
                            </div>
                            <div className='text-center mt-4'>
                                <div className='flex items-center space-x-3'>
                                    <div className="flex-1 h-px sm:w-16 dark:bg-orange-600"></div>
