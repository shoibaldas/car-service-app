    ...
    return (
        <div className="navbar p-2 h-20 mb-8 bg-base-100">
            ...
            <div className="navbar-end">
                <button className="outline outline-offset-2 outline-1 rounded px-4 py-2 border-orange-600 text-orange-600 font-semibold hover:bg-orange-600 hover:text-gray-100 hover:outline-none ease-in duration-200">Appointment</button>
            </div>
        </div>
    );
};
